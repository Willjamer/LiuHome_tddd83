...
const [showForm, setShowForm] = useState(true);
      ...
      const interval = setInterval(async () => {
        try {
          ...
          if (statusJson.status === "PAID") {
            ...
            try {
              const apartmentRes = await fetch("http://localhost:3001/api/add-apartment", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
  ...
  return (
        ...
        <Card className="max-w-3xl mx-auto shadow-lg border-0 rounded-xl overflow-hidden">
          <CardHeader className="bg-gray-100 text-black p-8">
            ...
            <CardDescription className="text-gray-700 mt-2">
              Please make sure to fill out all fields in the form below. All fields are required.
            </CardDescription>
          </CardHeader>
    ...
    <p className="mt-4 text-blue-600 font-medium">Väntar på Swish-betalning...</p>
  </div>
) : paid ? (
  <div className="flex flex-col items-center justify-center p-10">
    <div className="text-green-600 text-4xl mb-2">✅</div>
    <p className="text-green-700 text-xl font-semibold">Swish betalning genomförd!</p>
  </div>
        ) : (
          <>
            <div className="absolute top-6 right-6">
              <img src="/images/swish-logo.png" alt="Swish logo" className="w-16" />
            </div>
